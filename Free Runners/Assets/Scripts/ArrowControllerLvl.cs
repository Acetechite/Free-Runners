...
public class ArrowControllerLvl : MonoBehaviour {

	public GameObject walkPark;
	public GameObject constAhead;
	public GameObject hurdleHell;
	...
	void Start () {
		...
		changePos = false;
		isWaiting = false;
		buttonArray = new GameObject[] { walkPark, constAhead, hurdleHell, back};
